...
bind '"\C-t": "tmux new-window &> /dev/null\C-m"'
...
# bind '"\C-\eh": "silent tmux resize-pane -L 1\C-m"'
# bind '"\C-\ej": "silent tmux resize-pane -D 1\C-m"'
# bind '"\C-\ek": "silent tmux resize-pane -U 1\C-m"'
# bind '"\C-\el": "silent tmux resize-pane -R 1\C-m"'
